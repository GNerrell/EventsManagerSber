...
public class RoleService {
    ...
    public Role getById(Long id) {
        return roleRepository.findRoleById(id).orElseThrow(() -> new DataLackException("Role with id = " + id + " not found!"));
    }
    public Role getByName(String name) {
        return roleRepository.findRoleByName(name).orElseThrow(() -> new DataLackException("Role with name = " + name + " not found!"));
    }
